...
class DataManip:
    ...
    def __save_password(self, filename, data, nonce, website):
        ...
        # exncrypt data and save to file using master password
        def encrypt_data(self, filename, data, master_pass, website):
            ...
            # can never be reused; will be convered back to bytes while decrypting but stored as hex since json doesn't support bytes
        ...
        def decrypt_data(self, filename, master_pass, website):
