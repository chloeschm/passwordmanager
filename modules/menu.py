...
class Manager:
    ...
    # displays menu prompt and returns user choice
    ...
    # updates or adds a password to DB
    ...
    # loads a stored password from DB
    ...
    # deletes the entire password database
    ...
    # deletes all data including master password and password file
